    ...
    <section className={styles.ctaSection} ref={ref}>
      <div className={`container ${styles.ctaContainer}`}>
        <div className={`${styles.ctaContent} ${inView ? styles.visible : ''}`}>
          <h2 className={styles.ctaHeadline}>No More Project Stress. Let's Build Yours Today!</h2>
          <p className={styles.ctaSubtext}>
            DM us on Instagram or WhatsApp — we'll handle everything from code to viva!
          </p>
