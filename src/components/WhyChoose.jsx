...
const WhyChoose = () => {
  ...
  const features = [
    {
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ width: '36px', height: '36px', color: 'var(--primary-teal)' }}>
  ...
  return (
    <section className={styles.whyChoose} ref={ref}>
      <div className={`container ${styles.whyChooseContainer}`}>
        <h2 className={styles.sectionTitle}>Why Partner With Tattva?</h2>
